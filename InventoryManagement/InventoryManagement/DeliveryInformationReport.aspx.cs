    ...
    public partial class DeliveryInformationReport : System.Web.UI.Page
    {
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dt = objDeliveryInformation.GetDeliveryInformationReport(Convert.ToDateTime(TxtFromDate.Text).ToString("yyyy-MM-dd HH:mm:ss"), Convert.ToDateTime(TxtToDate.Text).ToString("yyyy-MM-dd HH:mm:ss"));
