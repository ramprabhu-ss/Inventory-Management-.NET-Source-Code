            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <asp:GridView ID="grdUserMaster" runat="server" CssClass="table table-striped"
                            AutoGenerateColumns="false" DataKeyNames="user_id" OnRowEditing="grdUserMaster_RowEditing"
                            OnRowUpdating="grdUserMaster_RowUpdating" OnRowCancelingEdit="grdUserMaster_RowCancelingEdit"
                            OnRowDeleting="grdUserMaster_RowDeleting">
                            <Columns>
